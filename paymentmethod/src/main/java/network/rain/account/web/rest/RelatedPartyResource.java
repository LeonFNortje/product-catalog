...
import network.rain.account.service.RelatedPartyService;
...
/**
 * REST controller for managing {@link network.rain.account.domain.RelatedParty}.
 */
@RestController
@RequestMapping("/api")
public class RelatedPartyResource {
    ...
    private static final String ENTITY_NAME = "paymentmethodRelatedParty";

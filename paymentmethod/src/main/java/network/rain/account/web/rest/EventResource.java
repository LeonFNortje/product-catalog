...
import network.rain.account.service.EventService;
...
public class EventResource {
    ...
    public ResponseEntity<EventDTO> updateEvent(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, eventDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<EventDTO> partialUpdateEvent(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, eventDTO.getId())
        );
    }

...
describe('PaymentMethod Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'paymentmethod/payment-method', component: PaymentMethodComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.paymentMethods?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });

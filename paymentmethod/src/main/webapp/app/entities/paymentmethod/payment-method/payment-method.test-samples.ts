...
export const sampleWithPartialData: IPaymentMethod = {
  ...
  name: 'teal',
  statusDate: dayjs('2022-10-30T18:46'),
  statusReason: 'transmitting',
  validForFrom: dayjs('2022-10-30T17:03'),
};
...
export const sampleWithFullData: IPaymentMethod = {
  ...
  status: 'Concrete',
  statusDate: dayjs('2022-10-30T22:34'),
  statusReason: 'granular vertical',
  validForFrom: dayjs('2022-10-31T12:49'),
  validForTo: dayjs('2022-10-30T16:52'),

...
describe('Event e2e test', () => {
  ...
  describe('new Event page', () => {
    ...
    it('should create an instance of Event', () => {
      ...
      cy.get(`[data-cy="eventTime"]`).type('2022-10-31T03:49').blur().should('have.value', '2022-10-31T03:49');
      ...
      cy.get(`[data-cy="timeOccurred"]`).type('2022-10-31T12:51').blur().should('have.value', '2022-10-31T12:51');

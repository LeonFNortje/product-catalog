...
describe('PaymentMethod e2e test', () => {
  ...
  describe('new PaymentMethod page', () => {
    ...
    it('should create an instance of PaymentMethod', () => {
      ...
      cy.get(`[data-cy="statusDate"]`).type('2022-10-31T04:47').blur().should('have.value', '2022-10-31T04:47');

      cy.get(`[data-cy="statusReason"]`).type('incubate online').should('have.value', 'incubate online');

      cy.get(`[data-cy="validForFrom"]`).type('2022-10-31T16:14').blur().should('have.value', '2022-10-31T16:14');

      cy.get(`[data-cy="validForTo"]`).type('2022-10-31T04:41').blur().should('have.value', '2022-10-31T04:41');

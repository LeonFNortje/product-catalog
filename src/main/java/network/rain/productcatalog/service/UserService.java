package network.rain.productcatalog.service;

import java.time.Instant;
import java.util.*;
import java.util.stream.Collectors;
import network.rain.productcatalog.config.Constants;
import network.rain.productcatalog.domain.Authority;
import network.rain.productcatalog.domain.User;
import network.rain.productcatalog.repository.AuthorityRepository;
import network.rain.productcatalog.repository.UserRepository;
import network.rain.productcatalog.security.SecurityUtils;
import network.rain.productcatalog.service.dto.AdminUserDTO;
import network.rain.productcatalog.service.dto.UserDTO;

...
public class ProductSpecificationCharacteristicService {
     ...
     */
    public ProductSpecificationCharacteristicDTO save(ProductSpecificationCharacteristicDTO productSpecificationCharacteristicDTO) {
        log.debug("Request to save ProductSpecificationCharacteristic : {}", productSpecificationCharacteristicDTO);
        ProductSpecificationCharacteristic productSpecificationCharacteristic = productSpecificationCharacteristicMapper.toEntity(
            productSpecificationCharacteristicDTO
        );
        productSpecificationCharacteristic = productSpecificationCharacteristicRepository.save(productSpecificationCharacteristic);
        return productSpecificationCharacteristicMapper.toDto(productSpecificationCharacteristic);
    }
     ...
     * @return the persisted entity.
     */
    public ProductSpecificationCharacteristicDTO update(ProductSpecificationCharacteristicDTO productSpecificationCharacteristicDTO) {
        log.debug("Request to update ProductSpecificationCharacteristic : {}", productSpecificationCharacteristicDTO);
        ProductSpecificationCharacteristic productSpecificationCharacteristic = productSpecificationCharacteristicMapper.toEntity(
            productSpecificationCharacteristicDTO
        );
        productSpecificationCharacteristic.setIsPersisted();
        productSpecificationCharacteristic = productSpecificationCharacteristicRepository.save(productSpecificationCharacteristic);
        return productSpecificationCharacteristicMapper.toDto(productSpecificationCharacteristic);
    }
     ...
     * @return the persisted entity.
     */
    public Optional<ProductSpecificationCharacteristicDTO> partialUpdate(
        ...
        return productSpecificationCharacteristicRepository
            ...
            .map(productSpecificationCharacteristicRepository::save)
    ...
    public Page<ProductSpecificationCharacteristicDTO> findAll(Pageable pageable) {
        log.debug("Request to get all ProductSpecificationCharacteristics");
        return productSpecificationCharacteristicRepository.findAll(pageable).map(productSpecificationCharacteristicMapper::toDto);
    }
     ...
     */
    @Transactional(readOnly = true)
    public Optional<ProductSpecificationCharacteristicDTO> findOne(String id) {
    ...
    public void delete(String id) {
        ...
        productSpecificationCharacteristicRepository.deleteById(id);
    }
}

...
public class ProductSpecificationCharacteristicRelationshipService {
     ...
     */
    public ProductSpecificationCharacteristicRelationshipDTO save(
        ...
        ProductSpecificationCharacteristicRelationship productSpecificationCharacteristicRelationship = productSpecificationCharacteristicRelationshipMapper.toEntity(
            productSpecificationCharacteristicRelationshipDTO
        );
        productSpecificationCharacteristicRelationship =
            productSpecificationCharacteristicRelationshipRepository.save(productSpecificationCharacteristicRelationship);
        return productSpecificationCharacteristicRelationshipMapper.toDto(productSpecificationCharacteristicRelationship);
    }
     ...
     * @return the persisted entity.
     */
    public ProductSpecificationCharacteristicRelationshipDTO update(
        ProductSpecificationCharacteristicRelationshipDTO productSpecificationCharacteristicRelationshipDTO
    ) {
        log.debug(
        ...
        productSpecificationCharacteristicRelationship.setIsPersisted();
        productSpecificationCharacteristicRelationship =
            productSpecificationCharacteristicRelationshipRepository.save(productSpecificationCharacteristicRelationship);
        return productSpecificationCharacteristicRelationshipMapper.toDto(productSpecificationCharacteristicRelationship);
    }
     ...
     * @return the persisted entity.
     */
    public Optional<ProductSpecificationCharacteristicRelationshipDTO> partialUpdate(
        ProductSpecificationCharacteristicRelationshipDTO productSpecificationCharacteristicRelationshipDTO
    ) {
        log.debug(
        ...
        return productSpecificationCharacteristicRelationshipRepository
            ...
            .map(productSpecificationCharacteristicRelationshipRepository::save)
    ...
    public Page<ProductSpecificationCharacteristicRelationshipDTO> findAll(Pageable pageable) {
     ...
     */
    @Transactional(readOnly = true)
    public Optional<ProductSpecificationCharacteristicRelationshipDTO> findOne(String id) {
    ...
    public void delete(String id) {
        ...
        productSpecificationCharacteristicRelationshipRepository.deleteById(id);
    }
}

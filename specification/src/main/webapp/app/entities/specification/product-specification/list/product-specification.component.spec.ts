...
describe('ProductSpecification Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'specification/product-specification', component: ProductSpecificationComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.productSpecifications?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });

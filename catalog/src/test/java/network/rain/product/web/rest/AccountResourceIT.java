...
import static network.rain.product.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static network.rain.product.test.util.OAuth2TestUtil.authenticationToken;
import static network.rain.product.test.util.OAuth2TestUtil.registerAuthenticationToken;

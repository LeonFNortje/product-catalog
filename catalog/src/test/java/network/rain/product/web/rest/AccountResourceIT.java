...
import static network.rain.product.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;

import java.time.Instant;
import java.util.*;
import network.rain.product.IntegrationTest;
import network.rain.product.config.Constants;
import network.rain.product.domain.User;
import network.rain.product.repository.AuthorityRepository;
import network.rain.product.repository.UserRepository;
import network.rain.product.security.AuthoritiesConstants;
import network.rain.product.service.UserService;
import network.rain.product.service.dto.AdminUserDTO;
import network.rain.product.service.dto.PasswordChangeDTO;
import network.rain.product.service.dto.UserDTO;
import network.rain.product.web.rest.vm.KeyAndPasswordVM;
import network.rain.product.web.rest.vm.ManagedUserVM;

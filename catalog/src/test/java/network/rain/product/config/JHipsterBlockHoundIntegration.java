...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("network.rain.product.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("network.rain.product.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
